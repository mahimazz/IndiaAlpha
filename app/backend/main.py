...
app = FastAPI(title="IndiaAlpha API", description="Backend API for IndiaAlpha API", version="0.1.0")
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "https://indiaalpha-frontend.onrender.com"],  # Frontend URLs
